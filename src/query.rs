...
pub fn start(node_end_point:String, block_num_total:usize, cnt:u64) -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Minimum with block_batch_size={} and block_concurrency={}", block_batch_min, block_concurrency_min);
    ...
    println!("Maximum with block_batch_size={} and block_concurrency={}", block_batch_max, block_concurrency_max);
    ...
    println!("Minimum with tx_batch={} and tx_concurrency={}", tx_batch_min, tx_concurrency_min);
    ...
    println!("Maximum with tx_batch={} and tx_concurrency={}", tx_batch_max, tx_concurrency_max);
